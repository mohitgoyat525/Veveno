...
const GrowthPartners = () => {
    ...
    const renderTabContent = () => {
            ...
            return (
                <div className='bg-cover bg-no-repeat bg-center lg:bg-tabOneBgImg max-lg:bg-tabOneSmImg w-full max-w-[1280px] max-lg:h-full h-[720px] mx-auto'>
                    <div className='ps-[79px] pt-[75px] max-lg:p-12 max-md:p-8 max-sm:p-5'>
                        ...
                        <div className=''>
                            <img src="/assets/images/png/patners-logo-img.png" alt="logo" className='max-w-[189px] lg:hidden mx-auto' />
                            <img src="/assets/images/png/tab-one-card.png" alt="card"  className='lg:hidden max-w-[320px] mt-5 mx-auto' />
                        </div>
                  </div>
                </div>
            );
            ...
            return (
                <div className='bg-cover bg-no-repeat bg-center lg:bg-tabTwoBgImg max-lg:bg-tabTwoSmImg w-full max-w-[1337px] max-lg:h-full h-[720px] mx-auto'>
                    ...
                    <h3 className='text-white font-bold text-custom8xl max-xl:text-6xl max-lg:text-5xl max-md:text-4xl font-sohne leading-[70px]'>Proven Results</h3>
                        <p className='max-w-[360px] font-light text-custom3xl max-md:text-2xl max-lg:pb-7 text-white leading-[30px]'>Not hopes and prayers.</p>
                        <img src="/assets/images/png/data-group.png" alt="data"  className='lg:hidden mx-auto'/>
                        </div>
                </div>
            );
        }
        ...
        if (activeTab === 3) {
            return (
                <div className='lg:bg-tabThreeBgImg max-lg:bg-tabThreeSmImg max-lg:h-full bg-cover bg-center bg-no-repeat w-full max-w-[1337px] h-[720px] mx-auto'>
                    <div className='pt-[75px] ps-[79px] max-lg:p-12 max-md:p-8 max-sm:p-5'>
                        ...
                        <button className='max-lg:mb-6 mt-[57px] flex items-center text-black text-customsm font-semibold leading-[15px] py-[31px] gap-[10px] px-[28px] border border-solid bg-[#D2F038] border-[#D2F038] max-w-[274px]'>Call to Action Somewhere <ButtonArrow /> </button>
                        <div className=''>
                            <img src="/assets/images/png/card-data-img.png" alt="card-data" className='lg:hidden' />
                        </div>
                 </div>
                </div>
            );
