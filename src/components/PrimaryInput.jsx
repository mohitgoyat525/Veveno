      ...
      <div className='bg-cover bg-center bg-no-repeat bg-inputImg h-[209px] max-xl:h-full'>
          <div className='flex items-center pt-[60px]  max-xl:py-10 max-md:py-5 max-xl:flex-wrap justify-center max-w-[1440px] mx-auto gap-[10rem]  max-xl:gap-7 relative'>
              <div className=''>
                  ...
                  <img src="/assets/images/svg/green-curve-line.svg" alt="line" className='absolute translate-x-[33px] translate-y-9 ' />    
              <div className=''>
                  <form className='bg-white flex items-center w-[446px] justify-between border-white border rounded-full'>
